...
# LDAP
$ldap_url = "ldap://<YOUR 1ST DC-SERVER>/ ldap://<YOUR 2ND DC-SERVER>/";
$ldap_starttls = true;
$ldap_binddn = "<SERVICE-ACCOUNT DN>";
$ldap_bindpw = "<SERVICE-ACCOUNT PASSWORD>";
# $ldap_krb5ccname = "/run/apache2/krb5ccache";

$ldap_base = '<BASE-DN OF YOUR USER-ACCOUNTS>';
...
$pwd_complexity = {% if g_all_domain_password_policies.default.complexity %}3{% else %}0{% endif %};
...
#$logo = "images/local_logo.png";

# No background image
# $background_image = "images/unsplash-space.jpeg";

$custom_css = "css/application.css";
...
if (array_key_exists("PHP_AUTH_USER", $_SERVER)) {
    $presetLogin = preg_replace("/[^a-zA-Z0-9-_@\.]+/", "", filter_var($_SERVER["PHP_AUTH_USER"], FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH));
}
